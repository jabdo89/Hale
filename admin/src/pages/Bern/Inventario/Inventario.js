          ...
          <Form>
            <FormGroup>
              ...
              <Input id="stock" name="stock" type="number" className="form-control"
                defaultValue={product.stock ? product.stock : 0} min={0}
                onChange={handleChange}
              />
            </FormGroup>
            <Row className="justify-content-end">
              <Button type="submit" color="primary" className="mr-1 waves-effect waves-light" onClick={updateInventory}>Save Changes</Button>
              <Button color="secondary" className="waves-effect" onClick={() => setmodal(!isOpen)}>Cancel</Button>
            </Row>
          </Form>
        </ModalBody>
      </div>
                      ...
                      <Col xl="7">
                        <div className="p-4 text-center text-xl-left">
                          <Row>
                            <Col md="12">
                              <div>
                                <p className="text-muted mb-2 text-truncate">Stock</p>
                                <h5>{product.stock}</h5>
                              </div>
                            </Col>
                          </Row>
